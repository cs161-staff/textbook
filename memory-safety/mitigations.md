...
<img src="/assets/images/memory-safety/mitigations/canary.png" alt="A stack canary located between the sfp and the local variables of a given stack frame" class="invertible">
