...
<img src="/assets/images/memory-safety/x86/1d-address-space.png" alt="1-dimensional address space light mode" class="invertible">
...
<img src="/assets/images/memory-safety/x86/2d-address-space.png" alt="2-dimensional address space light mode" class="invertible">
...
<img src="/assets/images/memory-safety/x86/memory-sections.png" alt="Memory sections" class="invertible">
...
<img src="/assets/images/memory-safety/x86/little-endian.png" alt="Little-endian word format" class="invertible">
...
<img src="/assets/images/memory-safety/x86/push.png" alt="Before and after of pushing an item onto the stack" class="invertible">
...
<img src="/assets/images/memory-safety/x86/pop.png" alt="Before and after of popping an item off the stack" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack0.png" alt="Initial stack diagram, with a stack frame for main at the top" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack1.png" alt="Next stack diagram, with argument 2 pushed below the stack frame for main and argument 1 pushed below argument 2" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack2.png" alt="Next stack diagram, with the old eip pushed below argument 1" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack3.png" alt="Next stack diagram, with the eip moved to the code for foo" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack4.png" alt="Next stack diagram, with the old ebp pushed below the old eip" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack5.png" alt="Next stack diagram, with the ebp moved to the esp" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack6.png" alt="Next stack diagram, with the esp down by 8 bytes" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack7.png" alt="Next stack diagram, with the 8 bytes previously allocated now having been used for local variables" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack8.png" alt="Next stack diagram, with the esp moved back up by 8 bytes" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack9.png" alt="Next stack diagram, with the old ebp popped off the stack and the ebp moved to its location" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack10.png" alt="Next stack diagram, with the old eip popped off the stack and the eip moved to its location" class="invertible">
...
<img src="/assets/images/memory-safety/x86/stack11.png" alt="Next stack diagram, with the esp moved up by 8 bytes to now be above the arguments" class="invertible">
